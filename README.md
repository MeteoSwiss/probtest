...
`PROBTEST_TEST_EXPERIMENT`: full sets of reference data are generated for both the `mch_opr_r04b07` and `atm_amip_les_test` experiments. Chose one of the two or run both sequentially.
