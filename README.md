...
#### Setup with Poetry (Recommended for Developers)

This setup is recommended for developers and is required if you want to **change or add dependencies**.
It assumes you have **Poetry installed** and are using **Python 3.10**.
...
> **Note:**  
> The `export` command is provided by the optional  plugin
